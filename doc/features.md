...
- Information Seed discovery, which turns a topic or organization name into an auditable inventory of crawlable Sources.
- Read-only email and mailbox ingestion through IMAP, POP3, Gmail, Microsoft Graph, maildir, and mbox connectors.
