...
CREATE TABLE IF NOT EXISTS Memory (
    ...
    details JSONB NOT NULL                    -- actual memory payload
);
...
CREATE INDEX IF NOT EXISTS idx_memory_details
ON Memory USING gin(details jsonb_path_ops);
