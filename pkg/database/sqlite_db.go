...
func (handler *SQLiteHandler) QueryRowContext(ctx context.Context, query string, args ...interface{}) *sql.Row {
...
func (handler *SQLiteHandler) WaitForConnection(c cfg.Config, totalTimeout time.Duration) error {
