...
func TestMarshalJSON(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			expected: `{"values":"test string","key":"test_key","properties":{"persistent":true,"static":false,"session_valid":true,"type":"string","source":"source1"}}`,
		},
		{
			name: "Number value",
			input: EnvSetting{
			...
			expected: `{"values":42.5,"key":"test_key","properties":{"persistent":false,"static":true,"session_valid":false,"type":"number","source":"source2"}}`,
		},
		{
			name: "Array of strings",
			input: EnvSetting{
			...
			expected: `{"values":["a","b","c"],"key":"test_key","properties":{"persistent":true,"static":true,"session_valid":true,"type":"[]string","source":"source3"}}`,
		},
		{
			name: "Null value",
			input: EnvSetting{
			...
			expected: `{"values":null,"key":"test_key","properties":{"persistent":false,"static":false,"session_valid":false,"type":"null","source":"source4"}}`,
		},
	}
